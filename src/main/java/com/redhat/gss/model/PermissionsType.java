 ...
 *         &lt;element name="grant" type="{urn:jboss:module:1.3}permissionType"/>
 *       &lt;/choice>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class PermissionsType {
    ...
    protected List<PermissionType> grant;
     ...
     * 
     */
    public List<PermissionType> getGrant() {
        if (grant == null) {
            grant = new ArrayList<PermissionType>();
        }
        return this.grant;
    }
